...
var Prism = function () {
    var e = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
        t = self.Prism = {
            ...
            highlightElement: function (a, i, r) {
                ...
                if (l && (s = (l.className.match(e) || [, ""])[1], o = t.languages[s]), o) {
                    ...
                    if (u) {
                        ...
                        if (t.hooks.run("before-highlight", c), i && self.Worker) {
                            ...
                            p.onmessage = function (e) {
                                c.highlightedCode = n.stringify(JSON.parse(e.data), s), t.hooks.run("before-insert", c), c.element.innerHTML = c.highlightedCode, r && r.call(c.element), t.hooks.run("after-highlight", c)
                            }, p.postMessage(JSON.stringify({
                                language: c.language,
                                code: c.code
                            }))
                        } else c.highlightedCode = t.highlight(c.code, c.grammar, c.language), t.hooks.run("before-insert", c), c.element.innerHTML = c.highlightedCode, r && r.call(a), t.hooks.run("after-highlight", c)
                    }
                }
            },
            highlight: function (e, a, i) {
                var r = t.tokenize(e, a);
                                ...
                                if (!(m instanceof a)) {
                                    ...
                                    if (h) {
                                        ...
                                        var b = h.index - 1 + g,
                                            ...
                                            v = [f, 1];
                                        k && v.push(k);
                                        var _ = new a(s, c ? t.tokenize(h, c) : h, d);
    ...
    if (n.stringify = function (e, a, i) {
            ...
            t.hooks.run("wrap", r);
            var o = "";
            for (var l in r.attributes) o += l + '="' + (r.attributes[l] || "") + '"';
        ...
        var n = JSON.parse(e.data),
            a = n.language,
            i = n.code;
        self.postMessage(JSON.stringify(t.util.encode(t.tokenize(i, t.languages[a])))), self.close()
